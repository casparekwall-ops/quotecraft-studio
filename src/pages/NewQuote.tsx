        ...
        <div className="space-y-6 lg:col-span-2">
          ...
          <div className="rounded-xl border border-border bg-card p-6 shadow-card">
            ...
            <div className="grid gap-4">
              <div className="space-y-2"><Label>Notes</Label><Textarea placeholder="Additional notes..." value={notes} onChange={(e) => setNotes(e.target.value)} /></div>
              <div className="space-y-2"><Label>Terms & Conditions</Label><Textarea placeholder="Terms..." value={terms} onChange={(e) => setTerms(e.target.value)} /></div>
            </div>
          </div>
        </div>
